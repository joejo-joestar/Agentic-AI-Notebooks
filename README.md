...
| Groq API Key                   | `GROQ_API_KEY`      | [Groq Console](https://console.groq.com/keys)                                     |               [Groq API Docs](https://console.groq.com/docs/quickstart) and [LangChain Groq Integration Docs](https://docs.langchain.com/oss/python/integrations/providers/groq) |
